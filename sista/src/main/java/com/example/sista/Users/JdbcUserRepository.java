...
public class JdbcUserRepository implements UserRepository {
    ...
    @Override
    public boolean getStatusPembimbing(int idSidang, String email) {
        List<User> list = jdbcTemplate.query(
                "SELECT ds.idSidang, d.email, 'Pembimbing' AS namaRole FROM DosenSidang ds JOIN RoleDosen r ON ds.idRole = r.idRole JOIN Dosen d ON ds.NIP = d.NIP WHERE ds.idSidang = ? AND d.email = ? AND r.namaRole LIKE 'Pembimbing%'",
                this::mapRowToPembimbing, idSidang, email);
    ...
    private User mapRowToPembimbing(ResultSet resultSet, int rowNum) throws SQLException {
        return new User(
                null, null, null, null,
