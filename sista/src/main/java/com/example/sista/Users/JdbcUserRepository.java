    ...
    public boolean register(User user) {
        ...
        try {
            if (role.equals("Mahasiswa")) {
                ...
                sql = "INSERT INTO Mahasiswa (NIP, nama, email, passwords, statusKoordinator) VALUES (?,?,?,?)";
            ...
            int rowsEffected = jdbcTemplate.update(sql, user.getNoInduk(), user.getNama(), user.getEmail(),
                    user.getPasswords());
