...
document.getElementById("editButton").addEventListener("click", function() {
    if (isEditing) {
        ...
        document.getElementById("nilai5").value = savedValues.nilai5 || '';
...
document.getElementById("saveButton").addEventListener("click", function() {
    ...
    const nilai5 = document.getElementById("nilai5").value;
    ...
    if (nilai1 && nilai2 && nilai3 && nilai4 && nilai5) {
        ...
        document.getElementById("nilai5").outerHTML = `<td>${nilai5}</td>`;
...
document.getElementById("yesButton").addEventListener("click", function() {
    ...
    document.getElementById("nilai5").outerHTML = `<td>${savedValues.nilai5}</td>`;
});
