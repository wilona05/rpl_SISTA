...
public class JdbcBobotDosenRepository implements BobotDosenRepository{
    ...
    public void updateBobot(Integer idBobot, BigDecimal bobot, Date tglBerlaku){
        String sql = "UPDATE bobotDosen SET bobot=?, tglBerlaku=? WHERE idBobot=?";
        jdbcTemplate.update(sql, bobot, tglBerlaku, idBobot);
    }
}